...
const FollowupConfirm = ({booked,bookingFunc}) => {
  ...
  return (
   <>
    <div className='d-flex flex-column justify-content-center align-items-center'>
             ...
             <button onClick={bookingFunc}  className='p-1 rounded fw-semibold rounded-3 bg-info text-dark border-0 fs-4'>BOOK APPOINTMENT</button>
             </div>
...
export default FollowupConfirm